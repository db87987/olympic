ActiveAdmin.register Event do
  ...
  permit_params :published, :title, :category_id, :subject_id, :start_date, :end_date,
                :info_activated, :info_text, :info_file,
                :tasks_activated, :tasks_text, :tasks_file,
                :events_activated, :events_text, :events_file
  ...
  form do |f|
    f.inputs do
      input :published
      input :title
      input :category, as: :select2
      input :subject, as: :select2
